...
export const siteMetadata: ISiteMetadata = {
  ...
  id: "daopt",
  name: "盗亦有道",
  description: "世界是一个巨大的草台班子，盗亦有道，为什么不盗？小说特色站",
  tags: ["综合"],
  timezoneOffset: "+0800",
  ...
  category: [
    ...
    },
    {
      ...
      options: [
        { value: 1, name: "EPUB" },
        { value: 2, name: "PDF" },
        { value: 3, name: "MOBI/AZW3" },
        { value: 4, name: "DOC/TXT" },
        { value: 5, name: "CBZ/CBR" },
        { value: 6, name: "ZIP/RAR" },
        { value: 7, name: "JPG/PNG" },
      ],
      cross: { mode: "append" },
    },
    CategoryIncldead,
